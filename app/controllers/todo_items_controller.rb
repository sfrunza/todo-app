class TodoItemsController < ApplicationController
  ...
  def update
    ...
    @due_day = todo_item_params["due_at(1i)"] + "-" +todo_item_params["due_at(2i)"] + "-" + todo_item_params["due_at(3i)"]
